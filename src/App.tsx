...
function App() {
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-8">
      <h1 className='m-6  text-4xl  text-center font-light text-zinc-700'>Discover the Lowest Prices for BTC!</h1>
      ...
      <div className='mx-auto pt-10'>
        ...
        <div className='m-auto flex justify-center mt-40'> 
          <a className='flex justify-center' target="_blank"  href="https://github.com/thomasdev5832">
            Made with 🧡 by
              <svg className='ml-1' xmlns="http://www.w3.org/2000/svg" x="" y="" width="24" height="24" viewBox="0 0 48 48">
